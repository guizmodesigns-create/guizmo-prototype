    ...
    <div className="grid gap-8 md:grid-cols-2 md:gap-12">
      <div>
        ...
        <h2 className="mt-2 font-display text-3xl font-black tracking-tight text-white sm:text-4xl">
          Pick Your <span className="text-orange-400">Ride.</span>
        </h2>
        ...
        <div className="mt-6 space-y-4">
          <div>
            <label className="gz-label">What year is it?</label>
            <select
              className="gz-input"
              value={value.year}
              onChange={(e) =>
          ...
          <div>
            <label className="gz-label">Who made it?</label>
            <select
              className="gz-input"
          ...
          <div>
            <label className="gz-label">Which model?</label>
            <select
              className="gz-input"
