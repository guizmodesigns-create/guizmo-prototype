...
export default function HomePage() {
  ...
  const handleStartGeneration = useCallback(async () => {
    ...
    // Move to Step 6 — show the loading screen while concepts come in.
    setStep(6);
    ...
    setAllDone(true);
  }, [logoFile, vehicle, industry, industryOther, vibe, brand, colors, coverage, logo, contact]);
  ...
  const handleRequestQuote = useCallback(
    ...
    [vehicle, industry, industryOther, vibe, brand, colors, coverage, logo, contact],
  );
          ...
          <div className="bg-grid -mx-4 px-4 py-8 sm:-mx-6 sm:px-6">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-base text-ink-200 sm:text-lg">
                Six steps. Five minutes. Four concepts you'll actually want on
